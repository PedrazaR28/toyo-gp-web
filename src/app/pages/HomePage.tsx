...
const MERCADO_LIBRE_URL =
  "https://vehiculos.tucarro.com.co/_CustId_206072185?utm_source=ig&utm_medium=social&utm_content=link_in_bio&fbclid=PAZXh0bgNhZW0CMTEAc3J0YwZhcHBfaWQPOTM2NjE5NzQzMzkyNDU5AAGnp13uraTXqD-ml3O6wCJbp6DBGCzPcng1QkSPnOUpchD6djoxxHKSQZtUXiY_aem_BDw_EM961vz4V8oSullXnA";
  ...
  useEffect(() => {
    ...
    if (metaTag) {
      metaTag.setAttribute(
        "content",
        "TOYO GP, especialistas en vehículos Toyota usados en Bogotá. Compra, venta, retoma y trámites vehiculares con más de 10 años de experiencia comercial."
      );
    }
  }, []);
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 sm:p-12 space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <label htmlFor="autorizo" className="text-gray-500 text-xs leading-relaxed">
                  ...
                  <Link
                    to="/tratamiento-datos-personales"
                    className="text-[#D90429] hover:underline font-medium"
                  >
                    Política de Tratamiento de Datos Personales
                  </Link>{" "}
                  de {LEGAL_DATA.nombreComercial}. *
                </label>
              </div>
              ...
              {[
                {
                  icon: MapPin,
                  label: "Dirección",
                  value: LEGAL_DATA.direccion,
                  sub: `${LEGAL_DATA.localidad}, ${LEGAL_DATA.ciudad}`,
                },
                {
                  icon: Clock,
                  label: "Horario de atención",
                  value: LEGAL_DATA.horarioSemana,
                  sub: LEGAL_DATA.horarioSabado,
                },
                {
                  icon: Phone,
                  label: "Teléfono / WhatsApp",
                  value: LEGAL_DATA.telefono,
                  sub: "Respuesta inmediata por WhatsApp",
                },
                {
                  icon: Mail,
                  label: "Correo electrónico",
                  value: LEGAL_DATA.correoContacto,
